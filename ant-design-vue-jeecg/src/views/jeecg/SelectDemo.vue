        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="选择分类">
              <j-select-material-cate v-decorator="['id']" :trigger-change="true"></j-select-material-cate>
            </a-form-item>
          </a-col>
          <a-col :span="12">选中的部门ID(v-decorator):{{ getDepartIdValue() }}</a-col>
        </a-row>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="选择物料">
              <j-select-material-by-cate v-decorator="['id']" :trigger-change="true"></j-select-material-by-cate>
            </a-form-item>
          </a-col>
          <a-col :span="12">选中的部门ID(v-decorator):{{ getDepartIdValue() }}</a-col>
        </a-row>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="选择司机">
              <j-select-driver-by-dep v-decorator="['id']" :trigger-change="true"></j-select-driver-by-dep>
            </a-form-item>
          </a-col>
          <a-col :span="12">选中的部门ID(v-decorator):{{ getDepartIdValue() }}</a-col>
        </a-row>
...
<script>
  ...
  import JSelectDriverByDep from '@/components/jeecgbiz/JSelectDriverByDep'
